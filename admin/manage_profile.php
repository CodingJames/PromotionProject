...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"></head>
  ...
  <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
        ...
        <div class="container">
        <div class="row">
     	<div class="col-md-12"><div align="center" class="style2"></div>
     	</div>
        </div>
        </div>
        <div class="container">
  ...
  <div class="row">
	    ...
	    <tr>
			  <td colspan="7" align="center" bgcolor="#FFFF66"> <?php
 	include('form_insert_admin.php');
 ?></td>
		  </tr>
			<tr>
            	<td width="6%" align="center" bgcolor="#FFFF99" ><span class="style4">ลำดับ</span></td>
              <td width="29%" align="center" bgcolor="#FFFF99" ><span class="style4">ชื่อผู้ดูแลระบบ</span></td>
              <td width="29%" align="center" bgcolor="#FFFF99" ><span class="style4">เบอร์โทรศัพท์</span></td>
              <td width="28%" align="center" bgcolor="#FFFF99" ><span class="style4">Username</span></td>
              <td width="23%" align="center" bgcolor="#FFFF99" ><span class="style4">Password</span></td>
              <td width="7%" align="center" bgcolor="#FFFF99" ><span class="style4">แก้ไข</span></td>
              <td width="7%" align="center" bgcolor="#FFFF99" ><span class="style4">ลบ</span></td>
          </tr>
              <?php
	...
	?>
            <tr>
            	<td align="center" bgcolor="#FFFFCC" ><?php echo $a; ?></td>
                <td bgcolor="#FFFFCC" ><?=$r['am_name'];?></td>
                <td bgcolor="#FFFFCC" align="center"><?=$r['am_phone'];?></td>
                <td bgcolor="#FFFFCC" ><?=$r['am_user'];?></td>
                <td bgcolor="#FFFFCC" ><?=$r['am_pass'];?></td>
               
              <form class="form-horizontal" action="form_edit_admin.php" method="post" enctype="multipart/form-data" name="form" id="form">
                <td align="center" bgcolor="#FFFFCC" ><button type="submit" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="top" title="edit"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button>
               <input type="hidden" name="am_user" value="<?=$r['am_user']?>">               </td></form>
                 <form class="form-horizontal" action="delete_admin.php" method="post" enctype="multipart/form-data" name="form" id="form">
                <td align="center" bgcolor="#FFFFCC" ><button type="submit" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="top" title="delete"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button> 
                <input type="hidden" name="am_user" value="<?=$r['am_user']?>">                                </td></form>
            </tr>
            <?php
			$a++;
        ...
        <div class="col-md-3" align="right"><iframe src="http://www.tmd.go.th/daily_forecast_forweb.php?strProvinceID=37-19-27-21-31-30-34" width="180" height="260" scrolling="no" frameborder="0"></iframe></div>
  </div>
