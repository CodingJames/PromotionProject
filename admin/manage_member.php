...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"></head>
  ...
  <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
        ...
        <div class="row">
     	<div class="col-md-12">
     	  <div align="center" class="style2">     	    
   	      จัดการข้อมูลสมาชิก</p>
         </div>
         <div class="col-md-12" align="center">
        <table class="table table-bordered" align="center">
			<tr bgcolor="#FFFF66">
            	<td align="center">รหัสสมาชิก</td>
                <td align="center">ชื่อสมาชิก</td>
                <td align="center">ชื่อเข้าระบบ</td>
                <td align="center">รหัสผ่านเข้าระบบ</td>
                <td align="center">เพศ</td>
                <td align="center">เบอร์โทรศัพท์</td>
                <td align="center">หมวดหมู่ที่รับข้อมูล</td>
			...
			$rows = 5;
			$total_data=mysql_num_rows(mysql_query("select * from tb_customer"));
			...
			$sql = "select * from tb_customer limit $start,5";
			//echo $sql; exit();
	...
	?>
            <tr bgcolor="#FFFFCC">
            	<td align="center"><?=$r["cm_id"]; ?></td>                    
                <td align="center"><?=$r["cm_name"]?></td>
                <td align="center"><?=$r["cm_user"]?></td>
                <td align="center"><?=$r["cm_pass"]?></td>
                <td align="center"><?=$r["cm_gender"]?></td>
                <td align="center"><?=$r["cm_tel"]?></td>
                <td align="center"><?=$r["cm_accept_cate"]?></td>
                <td align="center"><a href="form_edit_member.php?cm_id=<?=$r["cm_id"];?>">เลือก</a></td>
                <form class="form-horizontal" action="delete_member.php" method="post" enctype="multipart/form-data" name="form" id="form">
                <td align="center"><button type="submit" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="top" title="delete"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button>
  ...
  <ul class="pagination">
    <li <?php if($page==1) echo 'class = "disabled"'; ?>>
      <a href="manage_member.php?page=<?=$page - 1 ?>" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </a>
    </li>
    <?php for($i=1;$i<=$total_page;$i++){ ?>
    <li <?php if($page==$i) echo 'class = "active"'; ?>><a href="manage_member.php?page=<?=$i ?>"><?=$i?></a></li>   
    <?php } ?> 
    <li <?php if($page==$total_page) echo 'class = "disabled"'; ?>>
      <a href="manage_member.php?page=<?=$page + 1 ?>" aria-label="Next">
