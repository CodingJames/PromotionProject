  ...
  <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
        ...
        <div class="row">
     	<div class="col-md-12">
          ...
          <p></div>
        <form class="form-horizontal" action="edit_category.php" method="post" enctype="multipart/form-data" name="form" id="form">
     <?php
		 include("connect_db.php");
         $tp_id = $_REQUEST['tp_id'];	
		// $am_user = $_GET['am_user'];	
		
		 $sql = "select * from tb_type where tp_id = '$tp_id'";
     ...
     ?>
        <table class="table table-bordered" align="center">
            ...
            <td>
             	<div class="form-group">
    <label for="inputPassword3" class="col-sm-5 control-label">รหัสหมวดหมู่</label>
             	<div class="form-group">
    <label for="inputPassword3" class="col-sm-1 control-label"><?=$r["tp_id"]; ?></label>
          		</div>
          		</div>
                <div class="form-group">
    <label for="inputPassword3" class="col-sm-5 control-label">ชื่อหมวดหมู่</label>
             	<div class="col-sm-5">  
                <input type="text" class="form-control" name="tp_name" id="tp_name" value="<?=$r["tp_name"]?>" required >
          		</div>
          		</div>
