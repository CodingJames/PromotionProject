  ...
  <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
        ...
        <div class="row">
     	<div class="col-md-12">
          ...
          <p><?php include("form_insert_promotion.php"); ?></p></div>
          <div align="center">
        <table class="table table-bordered" align="center">
			...
			$search = (isset($_POST['p_search']))? $_POST['p_search']:'';
		
			$sql = "select * from tb_promotion where pt_headline like '%".$search."%' limit $start,5 ";
			//echo $sql; exit();
	...
	?>
            <tr class="active">
                ...
                <td align="left" bgcolor="#FADEF7"><img src = "picproduct/<?=$r["pt_pic"]?>" alt="" width="100" height="100" /></td>
                ...
                <td  align="center"><a href="<?=$r["pt_link"]?>"><?=$r["pt_link"]?></a></td>
                <td  align="center"><?=$r["pt_td_id"]?></td>
                <td  align="center"><?=$r["pt_type"]?></td>
                <td align="center"><a href="form_edit_promotion.php?pt_id=<?=$r["pt_id"];?>">เลือก</a></td>
                <form class="form-horizontal" action="delete_promotion.php" method="post" enctype="multipart/form-data" name="form" id="form">
                ...
                <input type="hidden" name="pt_id" value="<?=$r["pt_id"]; ?>">
                </td></form>
            </tr>
              <?php
             	 }
