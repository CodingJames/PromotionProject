...
<form class="form-horizontal" action="insert_promotion.php" method="post" enctype="multipart/form-data" name="form" id="form">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" name="pt_content" id="pt_content" placeholder="รายละเอียด" required="required">
    </div>
  </div>
   <div class="form-group">
    ...
    <div class="col-sm-5">
     <select class="form-control" name="pt_type">     
			<option value="เสริมอาหาร"><font color="#000000">เสริมอาหาร</font></option>
